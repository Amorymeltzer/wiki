...
if (cfg.wgCanonicalNamespace === 'Special') {
	...
	case null:
		...
		case 'Special:Massdelete':
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Animum/massdelete.js&oldid=1004824583&action=raw&ctype=text/javascript'); //[[User:Animum/massdelete.js]]
			break;
		...
		*/
		...
		if (cfg.wgNamespaceNumber === 4) {
			...
			if (cfg.wgPageName === 'Wikipedia:Articles_for_creation/Redirects') {
				...
				mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Joeytje50/JWB.js&oldid=1006174463&action=raw&ctype=text/javascript'); // [[User:Joeytje50/JWB]], [[User:Joeytje50/JWB.js]]
			}
