...
mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Gary/comments_in_local_time.js&oldid=1016323705&action=raw&ctype=text/javascript');
...
if (cfg.wgCanonicalNamespace === 'Special') {
	...
	*/
	...
	if (cfg.wgNamespaceNumber === 0) {
		...
		mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Nardog/PlayAudioNow.js&oldid=1039268331&action=raw&ctype=text/javascript'); // [[User:Nardog/PlayAudioNow]], [[User:Nardog/PlayAudioNow.js]]
		...
		*/
		...
		if (cfg.wgNamespaceNumber === 4) {
			...
			// mw.loader.load('//en.wikipedia.org/w/index.php?title=User:MusikAnimal/responseHelper.js&oldid=1034426397&action=raw&ctype=text/javascript'); // placeholder
			...
			// mw.loader.load('//en.wikipedia.org/w/index.php?title=User:MusikAnimal/userRightsManager.js&oldid=1030303833&action=raw&ctype=text/javascript'); // placeholder
			...
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Enterprisey/delsort.js&oldid=1032990228&action=raw&ctype=text/javascript'); // [[User:Enterprisey/delsort.js]]
		...
		if ((cfg.wgNamespaceNumber === 4) || (cfg.wgNamespaceNumber % 2 === 1)) {
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Pythoncoder/Scripts/voteSymbols.js&oldid=1039635378&action=raw&ctype=text/javascript'); // [[User:Ais523/votesymbols.js]], [[User:Pythoncoder/Scripts/voteSymbols.js]], [[User:Pythoncoder/Scripts/voteSymbols]]
			...
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Enterprisey/reply-link.js&oldid=1038226039&action=raw&ctype=text/javascript'); // [[User:Enterprisey/reply-link.js]], [[User:Enterprisey/reply-link]]
