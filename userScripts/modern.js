	...
	if (mw.config.get('wgNamespaceNumber') === 0) {
		...
		*/
		...
		if ((mw.config.get('wgNamespaceNumber') === 4) || (mw.config.get('wgNamespaceNumber')%2 === 1)) {
			...
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Enterprisey/reply-link.js&oldid=1001358167&action=raw&ctype=text/javascript'); //[[User:Enterprisey/reply-link.js]], [[User:Enterprisey/reply-link]]
			/*All talks*/
			if (mw.config.get('wgNamespaceNumber') !== '4') {
