...
$(function () {
	...
	mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Evad37/duplinks-alt.js&oldid=1229783301&action=raw&ctype=text/javascript'); // [[User:Evad37/duplinks-alt]], [[User:Evad37/duplinks-alt.js]] replaced [[User:Ucucha/duplinks.js]]
	...
	*/
	...
	if (mw.config.get('wgAction') === 'edit' || mw.config.get('wgAction') === 'submit') {
		...
		mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Mesidast/Tidy_citations.js&oldid=1370475822&action=raw&ctype=text/javascript'); // [[User:Mesidast/Tidy citations.js]], [[User:Mesidast/Tidy citations]]; updated version of [[User:Meteor sandwich yum/Tidy citations.js]]
		...
		mw.loader.load('//de.wikipedia.org/w/index.php?title=Benutzer:TMg/autoFormatter.js&oldid=267624412&action=raw&ctype=text/javascript'); // [[m:User:TMg/autoFormatter]]
	}
});
// </nowiki>
