...
if (mw.config.get("wgNamespaceNumber") == "0") {
	...
	*/
	...
	if (mw.config.get("wgAction") == "edit" || mw.config.get("wgAction") == "submit") {
	    ...
	    mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Ohconfucius/script/formatgeneral.js&oldid=959590925&action=raw&ctype=text/javascript'); //[[User:Ohconfucius/script/formatgeneral.js]]
