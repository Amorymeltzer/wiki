...
$(function () {
	...
	*/
	...
	if (mw.config.get('wgAction') === 'edit' || mw.config.get('wgAction') === 'submit') {
		...
		mw.loader.load('//de.wikipedia.org/w/index.php?title=Benutzer:TMg/autoFormatter.js&oldid=260445949&action=raw&ctype=text/javascript'); // [[m:User:TMg/autoFormatter]]
	}
});
// </nowiki>
