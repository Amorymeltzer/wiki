...
if (mw.config.get('wgNamespaceNumber') === '0') {
	$(function () {
		...
		mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Evad37/duplinks-alt.js&oldid=1097482556&action=raw&ctype=text/javascript'); // [[User:Evad37/duplinks-alt]], [[User:Evad37/duplinks-alt.js]] replaced [[User:Ucucha/duplinks.js]]
		...
		*/
		...
		if (mw.config.get('wgAction') === 'edit' || mw.config.get('wgAction') === 'submit') {
			...
			mw.loader.load('//en.wikipedia.org/w/index.php?title=User:Ohconfucius/script/formatgeneral.js&oldid=1088936086&action=raw&ctype=text/javascript'); // [[User:Ohconfucius/script/formatgeneral.js]]
			...
			mw.loader.load('//de.wikipedia.org/w/index.php?title=Benutzer:TMg/autoFormatter.js&oldid=226184502&action=raw&ctype=text/javascript'); // [[m:User:TMg/autoFormatter]]
		}
	});
}
// </nowiki>
